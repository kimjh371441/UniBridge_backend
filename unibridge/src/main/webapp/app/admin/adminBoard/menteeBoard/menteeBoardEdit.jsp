...
<body>
  ...
  <form method="post" action="${pageContext.request.contextPath}/menteeBoardEditOk.admin" class="form-wrap" id = "editForm">
    ...
    <div class="form-actions">
      ...
      <button type="button" class="btn btn-red" id="btnEditCancel" data-board-number = "${board.menteeboardNumber}">취소</button>
    </div>
  </form>
