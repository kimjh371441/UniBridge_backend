		...
		<c:choose>
			<c:when test="${not empty boardList}">
		      <c:forEach var="board" items="${boardList}">
		          <a class="board-table-row" href="${pageContext.request.contextPath}/app/admin/adminBoard/mentorBoard/mentorBoardDetail.admin?boardNumber=${board.mentorboardNumber}" >
		             <div class="col col-no">
		                <c:out value="${board.getMentorboardNumber()}" />
		             </div>
