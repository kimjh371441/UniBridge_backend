...
<head>
    ...
    <script defer src="${pageContext.request.contextPath}/assets/js/user/mentee/myPage/userDelete/userDelete.js"></script>
</head>
<body>
    ...
    <div class="mainContainer">
        <aside>
            ...
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/mvc/auth/mentee/delete.my" class="active">회원 탈퇴</a></li>
            </ul>
        </aside>
        <main>
            ...
            <div class="userInputBox">
                <form id="deleteForm" action="${pageContext.request.contextPath}/mvc/auth/mentee/deleteOk.my" method="POST">
