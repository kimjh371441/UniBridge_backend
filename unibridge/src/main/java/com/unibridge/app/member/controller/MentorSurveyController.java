...
public class MentorSurveyController implements Execute{
	...
	private void doGet(HttpServletRequest request, HttpServletResponse response) {
		...
		if (loginUser != null) {
		    ...
		    // DAO 생성 및 데이터 조회
		    SurveyMentorDAO dao = new SurveyMentorDAO();
		    // surveyMapper.xml의 selectMenteeSurvey 실행
		    SurveyMentorDTO survey = dao.selectMentorSurvey(memberNumber);
