...
public class MentorwDeleteOkController implements Execute{

	@Override
    public Result execute(HttpServletRequest request, HttpServletResponse response) 
            throws ServletException, IOException {
        
    	System.out.println("=======MentorDeleteOkController=======");
    ...
    private Result goBack(HttpServletRequest request, Result result) {
        result.setPath("/app/user/mentor/myPage/userDelete/userDelete.jsp");
