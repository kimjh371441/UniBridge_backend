...
public class MainDTO {
    ...
    public static class ContestDTO {
        ...
        public void setContestNumber(int v)      { this.contestNumber = v; }
        ...
        public void setHostCompany(String v)     { this.hostCompany = v; }
        ...
        public String toString() {
            return "ContestDTO [contestNumber=" + contestNumber + ", title=" + title
    ...
    public static class MentorCardDTO {
        ...
        private String mentoringFile;      // 멘토링 첨부 파일명
        private int    subjectNumber;
        private String subjectName;        // UB_SUBJECT 조인
        private String memberNickname;     // UB_MEMBER 조인
        private int    memberProfile;      // UB_MEMBER 프로필 파일번호

        public MentorCardDTO() {}

        public String getInternalId()              { return internalId; }
        public void setInternalId(String v)        { this.internalId = v; }

        public int getMentorNumber()               { return mentorNumber; }
        public void setMentorNumber(int v)         { this.mentorNumber = v; }

        public String getMentoringTitle()          { return mentoringTitle; }
        public void setMentoringTitle(String v)    { this.mentoringTitle = v; }

        public String getMentoringGoal()           { return mentoringGoal; }
        public void setMentoringGoal(String v)     { this.mentoringGoal = v; }

        public String getMentoringDetail()         { return mentoringDetail; }
        public void setMentoringDetail(String v)   { this.mentoringDetail = v; }

        public String getMentoringFile()           { return mentoringFile; }
        public void setMentoringFile(String v)     { this.mentoringFile = v; }

        public int getSubjectNumber()              { return subjectNumber; }
        public void setSubjectNumber(int v)        { this.subjectNumber = v; }

        public String getSubjectName()             { return subjectName; }
        public void setSubjectName(String v)       { this.subjectName = v; }

        public String getMemberNickname()          { return memberNickname; }
        public void setMemberNickname(String v)    { this.memberNickname = v; }

        public int getMemberProfile()              { return memberProfile; }
        public void setMemberProfile(int v)        { this.memberProfile = v; }

        @Override
        public String toString() {
            return "MentorCardDTO [mentorNumber=" + mentorNumber
